...
function assertSafeImageUrl(url) {
  ...
  // Strict host allowlist — all uploaded files are hosted on base44.app.
  // This prevents SSRF and DNS-rebinding/TOCTOU since no separate resolution
  // step precedes the fetch.
